...
$margin = 40;
$outermargin = 40;
$logoText	= $this->params->get("logoText","COUNTRYSIDE");
...
$doc->addStyleSheet(JURI::base().'templates/system/css/general.css', $type = 'text/css');
$doc->addStyleSheet(JURI::base().'templates/'.$this->template.'/css/template.css', $type = 'text/css');
$doc->addStyleSheet(JURI::base().'templates/'.$this->template.'/css/grey.css', $type = 'text/css');
?>
...
<div id="footerwrap" class="gainlayout" style="width:<?php echo $pageWidth + $outermargin; ?>px;"> 
  ...
  <div id="a4j"><a href="http://a4joomla.com/"><?php echo JText::_('TPL_A4JOOMLA-COUNTRYSIDE-FREE_FOOTER_LINK_TEXT');?></a></div>  
</div>
