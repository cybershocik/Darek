...
// 			$this->path = JInstaller::getInstance()->getPath('extension_administrator');
		...
		private function deleteSwfUploader(){
			if(JVM_VERSION>0){
				...
				if(JFile::exists(VMPATH_ROOT. DS. 'language' .DS. 'en-GB'. DS. 'en-GB.com_virtuemart.sys.ini')){
					JFile::delete(VMPATH_ROOT. DS. 'language' .DS. 'en-GB'. DS. 'en-GB.com_virtuemart.sys.ini');
				}
