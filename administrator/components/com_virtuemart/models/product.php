 ...
 * @version $Id: product.php 8868 2015-06-09 00:34:19Z Milbo $
 */
...
//		print $orderby;
//		<div class="title">' . vmText::_ ('COM_VIRTUEMART_ORDERBY') . '</div>
//		$orderByList = '<div class="orderlistcontainer"><div class="activeOrder"><a title="' . $orderDirTxt . '" href="' . $link . '">' . vmText::_ ('COM_VIRTUEMART_ORDERBY') . '' . vmText::_ ('COM_VIRTUEMART_SEARCH_ORDER_' . $orderby) . ' ' . $orderDirTxt . '</a></div>';
		
		$orderByList = '<div class="orderlistcontainer" ><div class="activeOrder"style="font-size:12px;;"><a title="' . $orderDirTxt . '" href="' . $link . '">' . vmText::_ ('COM_VIRTUEMART_ORDERBY') . '' . vmText::_ ('COM_VIRTUEMART_SEARCH_ORDER_' . $orderby) . '</a></div>';
